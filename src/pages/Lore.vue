  ...
  <q-page class="row justify-center items-start ">
    <div class="text-content col-12 col-md-8 col-sm-10">
      <q-stepper v-model="path" header-nav vertical ref="stepper" color="primary" animated>
        <q-step name="/lore/introduction" title="Intoduction" icon="settings">
        ...
        <q-step name="/lore/birth-of-magic" title="Birth of Magic" icon="add_comment">
...
export default defineComponent({
  ...
  computed: {
    ...
    path: {
      ...
      set(val: string) {
        void this.$router.replace(val).catch();
      },
    },
  },
});
